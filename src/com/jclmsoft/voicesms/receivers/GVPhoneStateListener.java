	...
	public void onCallStateChanged(int state, String incomingNumber) {
		...
		switch (state) {
			...
			case TelephonyManager.CALL_STATE_RINGING:
				...
				if (same) {
					notificationMgr.notify(VoiceSMS.NOTIFICATION_CALL, OutgoingCallReceiver.buildOngoing(m_context, "Connected by Google Voice", "Connected by Google Voice", "You are connected through the Google Voice service"));
				}
				break;
		}
	}
