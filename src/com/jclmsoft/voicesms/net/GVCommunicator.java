package com.jclmsoft.voicesms.net;
...
import com.jclmsoft.voicesms.objects.Message;
import com.jclmsoft.voicesms.objects.Phone;
import com.jclmsoft.voicesms.objects.Voicemail;
...
public class GVCommunicator {
	...
	public boolean login(String username, String password) {
		...
		data.add(new BasicNameValuePair("source", "com-jclmsoft-voicesms-android"));
